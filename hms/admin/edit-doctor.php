...
if($sql)
{
$msg="Datos del Consejero actualizados con éxito";
...
<html lang="en">
	<head>
		<title>Admin | Editar detalles de Consejeros</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Editar detalles de Consejeros</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar información del Consejero</h5>
												</div>
...
<div class="form-group">
									<label for="fess">
																 Correo Electronico del Consejero
															</label>
