							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Consejeros </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="add-doctor.php">
											<span class="title"> Agregar Consejero</span>
										</a>
									</li>
									<li>
										<a href="Manage-doctors.php">
											<span class="title"> Administrar Consejero</span>
										</a>
									</li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Registros de sesiones del Consejeros </span>
										</div>
									</div>
								</a>
							</li>		
